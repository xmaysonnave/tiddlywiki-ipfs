...
Drag and drop the current [Ipfs with TiddlyWiki plugin](https://bluelightav.eth/#%24%3A%2Fplugins%2Fipfs) with and ENS compatible browserin your current TiddlyWiki instance.
