...
<p align="center">
  <a rel="noopener noreferrer" target="_blank" href="https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp">
...
### Latest [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production 'Available from GitHub')

#### `TiddlyWikis` editions

- **bluelightav.eth** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/editions/bluelightav 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/editions/bluelightav 'Available from GitHub')
- **empty** [![empty](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/editions/empty 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/editions/empty 'Available from GitHub')
- **tidlywiki.com** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/editions/tiddlywiki 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/editions/tiddlywiki 'Available from GitHub')

#### `IPFS with TiddlyWiki` boot, documentation, library modules and plugin

- **\$:/boot/boot.js** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/tiddlywiki-ipfs/boot/$_boot_boot.js-0.4.0-beta-TW-v5.1.23+build-201229490.json 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/tiddlywiki-ipfs/boot 'Available from GitHub')
- **\$:/ipfs/documentation** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/tiddlywiki-ipfs/documentation/$_ipfs_documentation.json-0.4.0-beta-TW-v5.1.23+build-201229490.json 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/tiddlywiki-ipfs/documentation 'Available from GitHub')
- **\$:/ipfs/library/modules** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/tiddlywiki-ipfs/library/$_library_ipfs-library-modules.js-1.0.0+build-201221372.json 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/tiddlywiki-ipfs/library 'Available from GitHub')
- **\$:/plugins/ipfs** [![Available from IPFS](/core/attachment/ipfs.png)](https://bluelightav.tk/ipfs/QmX9rfzhe6mCa5Hzgu4M3bdsrQvSnxrT5T8j1eTtPDoZsp/0.4.0-beta-TW-v5.1.23+build-201229490/tiddlywiki-ipfs/plugin/$_plugins_ipfs.js-0.4.0-beta-TW-v5.1.23+build-201229490.json 'Available from IPFS') [![Available from GitHub](/core/attachment/github.png)](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/production/tiddlywiki-ipfs/plugin 'Available from GitHub')
...
The [package.json](https://github.com/xmaysonnave/tiddlywiki-ipfs/tree/develop/package.json) references several options:
