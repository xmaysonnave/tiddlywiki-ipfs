  ...
  IpfsImport.prototype.import = async function (
    ...
    try {
      ...
      if (canonicalUri !== null || importUri !== null) {
        ...
        this.getLogger().info(
          `*** Processed: ${processed} and Removed "Duplicates": ${processedRemoved} Tiddler(s) ***`
        )
      }
      // // Update Tiddly
      ...
      for (var title of imported.keys()) {
        ...
        if (canonicalUri !== null || importUri !== null) {
          ...
          if (
            ...
            if (canonicalKey !== null && importKey !== null) {
              if (canonicalUri == null && importUri !== null) {
                var msg = 'Missing:'
                var field = '_canonical_uri'
                this.getLogger().info(
  ...
  IpfsImport.prototype.processTiddler = function (
    ...
    nextImportUri =
      ...
      nextImportUri.trim() === ''
        ? null
        : nextImportUri.trim()
    if (targetCanonicalKey !== null && canonicalKey !== targetCanonicalKey) {
      ...
      if (canonicalKey !== null && nextImportKey !== null) {
        if (
