...
cp ./production/tiddlywiki-ipfs/boot/\$_boot_boot.js-build.tid ./build/plugins/ipfs/config/\$_plugins_ipfs-\$_boot_boot.js-build.tid || exit 1
cp ./production/tiddlywiki-ipfs/library/\$_library_ipfs-modules.js-build.tid ./build/plugins/ipfs/config/\$_plugins_ipfs-\$_library_ipfs-modules.js-build.tid || exit 1
